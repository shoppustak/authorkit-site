...
│   ├── logo-bookpeek.svg       # Main logo (orange/navy)
│   ├── logo-bookpeek-white.svg # White logo variant
...
- Key files: `logo-bookpeek.svg`, `logo-bookpeek-white.svg`
...
- `api/_middleware.js`: Vercel edge middleware - routes based on hostname (bookshelf.bookpeek.club vs bookpeek.club)
...
- CSS custom properties: kebab-case: `--bookpeek-orange`, `--bookpeek-navy`
...
- Brand colors: Use CSS custom properties defined at top of `css/style.css` (--bookpeek-orange, etc.)
